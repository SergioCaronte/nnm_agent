...
int Evaluator::evaluate_position(const Board &board, const bool &white_turn, const bool &mill)
{
	int score = 0;
...
int Evaluator::evaluate_playing(const Board &board, const bool &white_turn, const bool &mill)
{
	int score = 0;
	SpotStatus me = white_turn ? SS_White : SS_Black;
	SpotStatus opp = white_turn ? SS_Black : SS_White;
...
int Evaluator::evaluate_flying(const Board &board, const bool &white_turn, const bool &mill)
{
	int score = 0;
	SpotStatus me = white_turn ? SS_White : SS_Black;
	SpotStatus opp = white_turn ? SS_Black : SS_White;
