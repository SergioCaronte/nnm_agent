...
public:
	...
	int evaluate_position(const Board &board, const bool &white_turn, const bool &mill);
	// função de utilidade do tabuleiro no estado de jogando
	int evaluate_playing(const Board &board, const bool &white_turn, const bool &mill);
	// função de utilidade do tabuleiro no estado de voando
	int evaluate_flying(const Board &board, const bool &white_turn, const bool &mill);
